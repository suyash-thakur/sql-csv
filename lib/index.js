...
// const query = `SELECT "What is your current yearly salary?" FROM table_name WHERE "What country do you reside in?" = 'Brazil' AND "Do you enjoy the work you do?" = 'Yes' GROUP BY "What is your current yearly salary?" ORDER BY "What is your current yearly salary?" DESC`
