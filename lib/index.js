...
const query = `SELECT department AS dep_name, COUNT(id) AS total_employees, MIN(salary) AS min_salary FROM employees GROUP BY department ORDER BY total_employees`
