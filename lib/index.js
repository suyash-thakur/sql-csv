...
const query = `SELECT SUM("What is your current yearly salary?") AS tot_sal, "What country do you reside in?" FROM table_name WHERE "Do you enjoy the work you do? " = 'Yes' GROUP BY "What country do you reside in?" ORDER BY "What is your current yearly salary?" DESC`
