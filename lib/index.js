...
const query = `SELECT SUM("What is your current yearly salary?") FROM table_name WHERE "What country do you reside in?" = 'Brazil' AND "Do you enjoy the work you do?" = 'Yes'`
