...
class CSVDatabase {
  ...
  async query(sql) {
    ...
    const selectAst = this.#selectAst(selectTokens);
    const fromAst = this.#fromAst(fromTokens);
    const whereAst = this.#whereAst(whereTokens);
    const groupByAst = this.#groupByAst(groupByTokens);
    const orderByAst = this.#orderByAst(orderByTokens);
